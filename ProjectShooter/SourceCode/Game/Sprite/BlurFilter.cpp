...
//シェーダファイル名(ディレクトリも含む)
const char SHADER_NAME[] = "Shader\\BlurFilter.hlsl";

BlurFilter::BlurFilter(const float fWidth, const float fHeight)
...
//シェーダを作成する.
HRESULT BlurFilter::CreateShader()
{
...
//ワールド変換.
void BlurFilter::ConversionWorld(D3DMATRIX &mWorld)
{
	D3DXMATRIX mTrans;
...
void BlurFilter::InputConstantBuffer(const D3DMATRIX mWorld)
{
