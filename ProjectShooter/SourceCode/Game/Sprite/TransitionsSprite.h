...
class TransitionsSprite : public BaseSprite
{
public:
	TransitionsSprite(const float DivisionQuantityWidth, const float DivisionQuantityHeight);
	virtual ~TransitionsSprite();
	...
	void SetMaskTexture(ID3D11ShaderResourceView* const pMaskTexture)
	{
...
private:
	...
	//マスク用テクスチャ.
	ID3D11ShaderResourceView*	m_pMaskTexture_SRV;
