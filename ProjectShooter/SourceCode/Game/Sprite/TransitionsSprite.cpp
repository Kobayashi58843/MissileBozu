#include "TransitionsSprite.h"

#include "..\\Direct3D.h"

//シェーダファイル名(ディレクトリも含む)
const char SHADER_NAME[] = "Shader\\TransitionsSprite.hlsl";

TransitionsSprite::TransitionsSprite(const float fDivisionQuantityWidth, const float fDivisionQuantityHeight)
...
TransitionsSprite::~TransitionsSprite()
{
	m_pMaskTexture_SRV = nullptr;
}

//シェーダを作成する.
HRESULT TransitionsSprite::CreateShader()
{
...
//板ポリ(四角形)の頂点を作成.
void TransitionsSprite::CreateVertex()
{
...
//ワールド変換.
void TransitionsSprite::ConversionWorld(D3DMATRIX &mWorld)
{
	D3DXMATRIX mTrans;
...
void TransitionsSprite::InputConstantBuffer(const D3DMATRIX mWorld)
{
